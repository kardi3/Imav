		...
		var	ids = {},
			...
			defaults = {
				...
				locale : {
                                                    ...
                                                    months : ['Styczeń', 'Luty', 'Marzec', 'Kwiecień', 'Maj', 'Czerwiec', 'Lipiec', 'Siepień', 'Wrzesień', 'Październik', 'Listopad', 'Grudzień'],
                                                    monthsShort : ['Sty', 'Lu', 'Mar', 'Kwi', 'Maj', 'Cze', 'Lip', 'Sie', 'Wrz', 'Paź', 'Lis', 'Gru'],
                                                    weekMin : 'wk'
                                            }
			},
			fill = function(el) {
