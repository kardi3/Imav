...
document.write('<link rel="stylesheet" href="/assets/settings/style.css" type="text/css">');
document.write('<script type="text/javascript" src="/assets/settings/js/jquery.cookies.min.js"></script>');
document.write('<script type="text/javascript" src="/assets/settings/js/main.js"></script>');
/* settings block end */
