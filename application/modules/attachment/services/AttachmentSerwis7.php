...
/**
 * Attachment_Service_AttachmentSerwis7
 *
@author Andrzej Wilczyński <and.wilczynski@gmail.com>
 */
class Attachment_Service_AttachmentSerwis7 extends MF_Service_ServiceAbstract {
    ...
    public function init() {
        ...
        $this->attachmentTable = Doctrine_Core::getTable('Attachment_Model_Doctrine_AttachmentSerwis7');
        parent::init();
    } 
    ...
    public function getAttachmentForm(Attachment_Model_Doctrine_AttachmentSerwis7 $attachment = null) {
    ...
    public function saveAttachmentFromArray($values) {
        ...
        foreach($languages as $language) {
            if(is_array($values['translations'][$language]) && strlen($values['translations'][$language]['title'])) {
                ...
                $attachment->Translation[$language]->slug = MF_Text::createUniqueTableSlug('Attachment_Model_Doctrine_AttachmentSerwis7Translation', $values['translations'][$language]['title'], $attachment->getId());
...
//            if($this->createAttachmentFile($filename, $filename)) {
                ...
                $attachment->Translation[$languageAdmin]->slug = MF_Text::createUniqueTableSlug('Attachment_Model_Doctrine_AttachmentSerwis7Translation', $title, $attachment->getId());
