 ...
 */
abstract class Blog_Model_Doctrine_BaseBlog extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('blog_blog');
    ...
    {
        parent::setUp();
        $this->hasMany('Blog_Model_Doctrine_BlogTranslation as Translation', array(
             'local' => 'id',
             'foreign' => 'id'));
