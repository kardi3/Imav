...
/**
 * Offer_Model_Doctrine_BaseNoticeParameter
 * 
 ...
 */
abstract class Offer_Model_Doctrine_BaseNoticeParameter extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('offer_notice_parameter');
