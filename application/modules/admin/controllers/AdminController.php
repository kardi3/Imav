...
//        $bestCategories = $categoryService->getBestCategories(10,  Doctrine_Core::HYDRATE_ARRAY);
//        $bestProducts = $productService->getBestProducts(10,  Doctrine_Core::HYDRATE_ARRAY);
//        
//        $bestProducts = array_reverse($bestProducts);
        
        $count = 0;
        foreach($bestCategories as $category): 
            $count = $count + $category['count_products'];
        endforeach;
        
        $this->view->assign('categories', $bestCategories);
        $this->view->assign('countAllProducts', $count);
        $this->view->assign('products', $bestProducts);
    }
